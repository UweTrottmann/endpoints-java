...
publishing {
    ...
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            pom {
                packaging = "jar"
                url.set("https://github.com/UweTrottmann/endpoints-java/")
                ...
                scm {
                    connection.set("scm:git@github.com:UweTrottmann/endpoints-java.git")
                    developerConnection.set("scm:git@github.com:UweTrottmann/endpoints-java.git")
                    url.set("https://github.com/UweTrottmann/endpoints-java/")
                }
            }
        }
